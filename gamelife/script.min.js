...
var checkAndCreate = function checkAndCreate(_) {
...
var ControlPanel = function () {
  ...
  _createClass(ControlPanel, [{
    ...
    value: function create() {
      ...
      var control = new _control.Control(createBlock());
      control.createButtons();
      control.insertButtons(_router.lifeGame.run);
      var insertButtons = control.insertButtons.bind(control);
      _router.eb.on("play", insertButtons);

      var slider = new _slider.Slider(createBlock());
      slider.create();

      var input = new _input.Input(createBlock());
      input.create();
